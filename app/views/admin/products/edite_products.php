      ...
      <div class="modal-body">
        ...
        ?>
          <div class="row">
           ...
           <div class="col-12">
              <div class="form-group">
                ...
                <input type="file"accept="image/*" name="product_main_image" class="form-control">
          ...
          <div class="col-12">
            ...
            <div class="col-12">
              <button type="submite" class="btn btn-primary submit-edit-product">Add Product</button>
            </div>
          </div>
          <?php $i++; } ?>   
        </form>
