...
?>
              ...
              <div class="signin my-5">
                <div class="signin-body" style="direction: rtl;">
                  ...
                  <div class="success"></div>
                    ...
                    <?php } ?>
                  <form class="form-signin" action="main/checklogincheckout" method="post">
        ...
        <div class="container">
          ...
          <span> ليس لديك حساب؟ </span><a style="color:#f79635;font-weight: 600;" class="register"  href="main/registercheckout">انشاء حساب</a>
          </div>
          </div>
         </div>
